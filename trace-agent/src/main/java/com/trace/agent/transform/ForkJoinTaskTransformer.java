...
public class ForkJoinTaskTransformer implements TraceTransformer {
    ...
    private static final String TRACE_RECURSIVE_TASK_CLASS_NAME = "com.trace.core.async.TraceRecursiveTask";
    ...
    public void doTransform(CtClass clazz) {
        try {
            ...
            clazz.addField(addField, "com.trace.core.Span.copyAsAsyncParent(com.trace.core.TraceContext.peek());");
            ...
            final String code = "{\n"
                    ...
                    + "   return " + originalDoExecMethodName + "($$);\n"
                    + "}\n"
                    + "com.trace.core.TraceContext.push(" + addFieldName + ");\n"
                    + "try {\n"
                    + "    return " + originalDoExecMethodName + "($$);\n"
                    + "}\n"
                    + "finally {\n"
